...
var file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_depIdxs = []int32{
	...
	7,  // 14: MembershipV2.CryptoCheckout.total:type_name -> MembershipV2.Amount
	9,  // 15: MembershipV2.GetProductsResponse.products:type_name -> MembershipV2.Product
	12, // 16: MembershipV2.GetStatusResponse.products:type_name -> MembershipV2.PurchasedProduct
	14, // 17: MembershipV2.GetStatusResponse.nextInvoice:type_name -> MembershipV2.Invoice
	0,  // 18: MembershipV2.GetStatusResponse.paymentProvider:type_name -> MembershipV2.PaymentProvider
	16, // 19: MembershipV2.GetStatusResponse.cryptoCheckout:type_name -> MembershipV2.CryptoCheckout
	15, // 20: MembershipV2.StoreCartGetResponse.cart:type_name -> MembershipV2.Cart
	13, // 21: MembershipV2.StoreCartUpdateRequest.products:type_name -> MembershipV2.CartProduct
	15, // 22: MembershipV2.StoreCartUpdateResponse.cart:type_name -> MembershipV2.Cart
	5,  // 23: MembershipV2.AnyNameIsValidResponse.code:type_name -> MembershipV2.AnyNameIsValidResponse.Code
	2,  // 24: MembershipV2.SubscribeToUpdatesRequest.platform:type_name -> MembershipV2.Platform
	35, // 25: AnyPaymentProcessingV2.SubscribeToUpdates:input_type -> MembershipV2.SubscribeToUpdatesRequest
	17, // 26: AnyPaymentProcessingV2.GetProducts:input_type -> MembershipV2.GetProductsRequest
	19, // 27: AnyPaymentProcessingV2.GetStatus:input_type -> MembershipV2.GetStatusRequest
	29, // 28: AnyPaymentProcessingV2.WebAuth:input_type -> MembershipV2.WebAuthRequest
	31, // 29: AnyPaymentProcessingV2.AnyNameIsValid:input_type -> MembershipV2.AnyNameIsValidRequest
	33, // 30: AnyPaymentProcessingV2.AnyNameAllocate:input_type -> MembershipV2.AnyNameAllocateRequest
	21, // 31: AnyPaymentProcessingV2.StoreCartGet:input_type -> MembershipV2.StoreCartGetRequest
	26, // 32: AnyPaymentProcessingV2.StoreCartUpdate:input_type -> MembershipV2.StoreCartUpdateRequest
	36, // 33: AnyPaymentProcessingV2.SubscribeToUpdates:output_type -> MembershipV2.SubscribeToUpdatesResponse
	18, // 34: AnyPaymentProcessingV2.GetProducts:output_type -> MembershipV2.GetProductsResponse
	20, // 35: AnyPaymentProcessingV2.GetStatus:output_type -> MembershipV2.GetStatusResponse
	30, // 36: AnyPaymentProcessingV2.WebAuth:output_type -> MembershipV2.WebAuthResponse
	32, // 37: AnyPaymentProcessingV2.AnyNameIsValid:output_type -> MembershipV2.AnyNameIsValidResponse
	34, // 38: AnyPaymentProcessingV2.AnyNameAllocate:output_type -> MembershipV2.AnyNameAllocateResponse
	22, // 39: AnyPaymentProcessingV2.StoreCartGet:output_type -> MembershipV2.StoreCartGetResponse
	27, // 40: AnyPaymentProcessingV2.StoreCartUpdate:output_type -> MembershipV2.StoreCartUpdateResponse
