...
func (MembershipV2_AnyNameIsValidResponse_Code) EnumDescriptor() ([]byte, []int) {
	return file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_rawDescGZIP(), []int{0, 25, 0}
}
...
type MembershipV2_Product struct {
	...
	PricesLifetime []*MembershipV2_Amount `protobuf:"bytes,13,rep,name=pricesLifetime,proto3" json:"pricesLifetime,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MembershipV2_Product) GetPricesLifetime() []*MembershipV2_Amount {
	if x != nil {
		return x.PricesLifetime
	}
	return nil
}
...
type MembershipV2_PurchaseInfo struct {
	...
	// 0 = not in a trial. Otherwise the Unix timestamp when the free trial ends,
	// which is also when the first real invoice is charged.
	DateTrialEnds uint64 `protobuf:"varint,5,opt,name=dateTrialEnds,proto3" json:"dateTrialEnds,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MembershipV2_PurchaseInfo) GetDateTrialEnds() uint64 {
	if x != nil {
		return x.DateTrialEnds
	}
	return 0
}
...
type MembershipV2_CryptoCheckout struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InvoiceURL    string                 `protobuf:"bytes,1,opt,name=invoiceURL,proto3" json:"invoiceURL,omitempty"`
	Total         *MembershipV2_Amount   `protobuf:"bytes,2,opt,name=total,proto3" json:"total,omitempty"`
	IsCanCancel   bool                   `protobuf:"varint,3,opt,name=isCanCancel,proto3" json:"isCanCancel,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MembershipV2_CryptoCheckout) Reset() {
	*x = MembershipV2_CryptoCheckout{}
	mi := &file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MembershipV2_CryptoCheckout) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MembershipV2_CryptoCheckout) ProtoMessage() {}

func (x *MembershipV2_CryptoCheckout) ProtoReflect() protoreflect.Message {
	mi := &file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MembershipV2_CryptoCheckout.ProtoReflect.Descriptor instead.
func (*MembershipV2_CryptoCheckout) Descriptor() ([]byte, []int) {
	return file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_rawDescGZIP(), []int{0, 9}
}

func (x *MembershipV2_CryptoCheckout) GetInvoiceURL() string {
	if x != nil {
		return x.InvoiceURL
	}
	return ""
...
func (x *MembershipV2_CryptoCheckout) GetTotal() *MembershipV2_Amount {
	if x != nil {
		return x.Total
	}
	return nil
...
func (x *MembershipV2_CryptoCheckout) GetIsCanCancel() bool {
	if x != nil {
		return x.IsCanCancel
	}
	return false
}
...
func (x *MembershipV2_SubscribeToUpdatesResponse) Reset() {
	*x = MembershipV2_SubscribeToUpdatesResponse{}
	mi := &file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MembershipV2_SubscribeToUpdatesResponse) Descriptor() ([]byte, []int) {
	return file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_rawDescGZIP(), []int{0, 29}
}
...
const file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_rawDesc = "" +
	...
	"\ranyNameMinLen\x18\a \x01(\rR\ranyNameMinLen\x1a\xe5\x03\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\bfeatures\x18\f \x01(\v2\x16.MembershipV2.FeaturesR\bfeatures\x12<\n" +
	"\x0epricesLifetime\x18\r \x03(\v2\x14.MembershipV2.AmountR\x0epricesLifetime\x1a\xc2\x01\n" +
	"\fPurchaseInfo\x12 \n" +
	...
	"\x06period\x18\x04 \x01(\x0e2\x14.MembershipV2.PeriodR\x06period\x12$\n" +
	"\rdateTrialEnds\x18\x05 \x01(\x04R\rdateTrialEnds\x1a\xb4\x01\n" +
	"\rProductStatus\x12:\n" +
	...
	"invoiceURL\x12*\n" +
	"\x05total\x18\x02 \x01(\v2\x14.MembershipV2.AmountR\x05total\x12 \n" +
	"\visCanCancel\x18\x03 \x01(\bR\visCanCancel\x1a\x14\n" +
...
var file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_goTypes = []any{
	...
	(*MembershipV2_CryptoCheckout)(nil),                 // 16: MembershipV2.CryptoCheckout
	(*MembershipV2_GetProductsRequest)(nil),             // 17: MembershipV2.GetProductsRequest
	(*MembershipV2_GetProductsResponse)(nil),            // 18: MembershipV2.GetProductsResponse
	(*MembershipV2_GetStatusRequest)(nil),               // 19: MembershipV2.GetStatusRequest
	(*MembershipV2_GetStatusResponse)(nil),              // 20: MembershipV2.GetStatusResponse
	(*MembershipV2_StoreCartGetRequest)(nil),            // 21: MembershipV2.StoreCartGetRequest
	(*MembershipV2_StoreCartGetResponse)(nil),           // 22: MembershipV2.StoreCartGetResponse
	(*MembershipV2_StoreCartPromocodeApplyRequest)(nil), // 23: MembershipV2.StoreCartPromocodeApplyRequest
	(*MembershipV2_StoreCartCheckoutRequest)(nil),       // 24: MembershipV2.StoreCartCheckoutRequest
	(*MembershipV2_StoreCartCheckoutResponse)(nil),      // 25: MembershipV2.StoreCartCheckoutResponse
	(*MembershipV2_StoreCartUpdateRequest)(nil),         // 26: MembershipV2.StoreCartUpdateRequest
	(*MembershipV2_StoreCartUpdateResponse)(nil),        // 27: MembershipV2.StoreCartUpdateResponse
	(*MembershipV2_StoreCartClearRequest)(nil),          // 28: MembershipV2.StoreCartClearRequest
	(*MembershipV2_WebAuthRequest)(nil),                 // 29: MembershipV2.WebAuthRequest
	(*MembershipV2_WebAuthResponse)(nil),                // 30: MembershipV2.WebAuthResponse
	(*MembershipV2_AnyNameIsValidRequest)(nil),          // 31: MembershipV2.AnyNameIsValidRequest
	(*MembershipV2_AnyNameIsValidResponse)(nil),         // 32: MembershipV2.AnyNameIsValidResponse
	(*MembershipV2_AnyNameAllocateRequest)(nil),         // 33: MembershipV2.AnyNameAllocateRequest
	(*MembershipV2_AnyNameAllocateResponse)(nil),        // 34: MembershipV2.AnyNameAllocateResponse
	(*MembershipV2_SubscribeToUpdatesRequest)(nil),      // 35: MembershipV2.SubscribeToUpdatesRequest
	(*MembershipV2_SubscribeToUpdatesResponse)(nil),     // 36: MembershipV2.SubscribeToUpdatesResponse
}
var file_paymentservice_paymentserviceproto_protos_paymentservice2_proto_depIdxs = []int32{
	...
	7,  // 3: MembershipV2.Product.pricesLifetime:type_name -> MembershipV2.Amount
	1,  // 4: MembershipV2.PurchaseInfo.period:type_name -> MembershipV2.Period
	3,  // 5: MembershipV2.ProductStatus.status:type_name -> MembershipV2.ProductStatus.Status
	9,  // 6: MembershipV2.PurchasedProduct.product:type_name -> MembershipV2.Product
	10, // 7: MembershipV2.PurchasedProduct.purchaseInfo:type_name -> MembershipV2.PurchaseInfo
	11, // 8: MembershipV2.PurchasedProduct.productStatus:type_name -> MembershipV2.ProductStatus
	9,  // 9: MembershipV2.CartProduct.product:type_name -> MembershipV2.Product
	7,  // 10: MembershipV2.Invoice.total:type_name -> MembershipV2.Amount
	4,  // 11: MembershipV2.Invoice.status:type_name -> MembershipV2.Invoice.Status
	13, // 12: MembershipV2.Cart.products:type_name -> MembershipV2.CartProduct
	7,  // 13: MembershipV2.Cart.total:type_name -> MembershipV2.Amount
	7,  // 14: MembershipV2.Cart.totalNextInvoice:type_name -> MembershipV2.Amount
	7,  // 15: MembershipV2.CryptoCheckout.total:type_name -> MembershipV2.Amount
	9,  // 16: MembershipV2.GetProductsResponse.products:type_name -> MembershipV2.Product
	12, // 17: MembershipV2.GetStatusResponse.products:type_name -> MembershipV2.PurchasedProduct
	14, // 18: MembershipV2.GetStatusResponse.nextInvoice:type_name -> MembershipV2.Invoice
	0,  // 19: MembershipV2.GetStatusResponse.paymentProvider:type_name -> MembershipV2.PaymentProvider
	16, // 20: MembershipV2.GetStatusResponse.cryptoCheckout:type_name -> MembershipV2.CryptoCheckout
	15, // 21: MembershipV2.StoreCartGetResponse.cart:type_name -> MembershipV2.Cart
	13, // 22: MembershipV2.StoreCartUpdateRequest.products:type_name -> MembershipV2.CartProduct
	15, // 23: MembershipV2.StoreCartUpdateResponse.cart:type_name -> MembershipV2.Cart
	5,  // 24: MembershipV2.AnyNameIsValidResponse.code:type_name -> MembershipV2.AnyNameIsValidResponse.Code
	2,  // 25: MembershipV2.SubscribeToUpdatesRequest.platform:type_name -> MembershipV2.Platform
	35, // 26: AnyPaymentProcessingV2.SubscribeToUpdates:input_type -> MembershipV2.SubscribeToUpdatesRequest
	17, // 27: AnyPaymentProcessingV2.GetProducts:input_type -> MembershipV2.GetProductsRequest
	19, // 28: AnyPaymentProcessingV2.GetStatus:input_type -> MembershipV2.GetStatusRequest
	29, // 29: AnyPaymentProcessingV2.WebAuth:input_type -> MembershipV2.WebAuthRequest
	31, // 30: AnyPaymentProcessingV2.AnyNameIsValid:input_type -> MembershipV2.AnyNameIsValidRequest
	33, // 31: AnyPaymentProcessingV2.AnyNameAllocate:input_type -> MembershipV2.AnyNameAllocateRequest
	21, // 32: AnyPaymentProcessingV2.StoreCartGet:input_type -> MembershipV2.StoreCartGetRequest
	26, // 33: AnyPaymentProcessingV2.StoreCartUpdate:input_type -> MembershipV2.StoreCartUpdateRequest
	36, // 34: AnyPaymentProcessingV2.SubscribeToUpdates:output_type -> MembershipV2.SubscribeToUpdatesResponse
	18, // 35: AnyPaymentProcessingV2.GetProducts:output_type -> MembershipV2.GetProductsResponse
	20, // 36: AnyPaymentProcessingV2.GetStatus:output_type -> MembershipV2.GetStatusResponse
	30, // 37: AnyPaymentProcessingV2.WebAuth:output_type -> MembershipV2.WebAuthResponse
	32, // 38: AnyPaymentProcessingV2.AnyNameIsValid:output_type -> MembershipV2.AnyNameIsValidResponse
	34, // 39: AnyPaymentProcessingV2.AnyNameAllocate:output_type -> MembershipV2.AnyNameAllocateResponse
	22, // 40: AnyPaymentProcessingV2.StoreCartGet:output_type -> MembershipV2.StoreCartGetResponse
	27, // 41: AnyPaymentProcessingV2.StoreCartUpdate:output_type -> MembershipV2.StoreCartUpdateResponse
