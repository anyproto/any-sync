...
func (x *GetTiersRequest) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
const file_paymentservice_paymentserviceproto_protos_paymentservice_tiers_proto_rawDesc = "" +
	...
	"\tsignature\x18\x02 \x01(\fR\tsignature\"\x97\x06\n" +
	"\bTierData\x12\x0e\n" +
	...
	"\x1apriceStripeUsdCentsMonthly\x18\x15 \x01(\rR\x1apriceStripeUsdCentsMonthly\"3\n" +
