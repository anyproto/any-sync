...
func (m *MockSyncAcl) HandleStreamRequest(arg0 context.Context, arg1 syncdeps.Request, arg2 syncdeps.QueueSizeUpdater, arg3 func(protoreflect.ProtoMessage) error) (syncdeps.Request, error) {
	m.ctrl.T.Helper()
