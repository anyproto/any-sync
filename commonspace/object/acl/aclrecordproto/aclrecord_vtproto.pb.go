...
func (m *AclRoot) CloneVT() *AclRoot {
	if m == nil {
		return (*AclRoot)(nil)
	}
	r := new(AclRoot)
	...
	if rhs := m.MasterKey; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.MasterKey = tmpBytes
	}
	if rhs := m.EncryptedReadKey; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.EncryptedReadKey = tmpBytes
	}
	if rhs := m.IdentitySignature; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.IdentitySignature = tmpBytes
	}
	if rhs := m.MetadataPubKey; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.MetadataPubKey = tmpBytes
	}
	if rhs := m.EncryptedMetadataPrivKey; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.EncryptedMetadataPrivKey = tmpBytes
	}
	if rhs := m.EncryptedOwnerMetadata; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.EncryptedOwnerMetadata = tmpBytes
	}
...
func (m *AclRoot) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountInvite) CloneVT() *AclAccountInvite {
	if m == nil {
		return (*AclAccountInvite)(nil)
	}
	r := new(AclAccountInvite)
	if rhs := m.InviteKey; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.InviteKey = tmpBytes
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *AclAccountInvite) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountRequestJoin) CloneVT() *AclAccountRequestJoin {
	if m == nil {
		return (*AclAccountRequestJoin)(nil)
	}
	r := new(AclAccountRequestJoin)
	r.InviteRecordId = m.InviteRecordId
	if rhs := m.InviteIdentity; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.InviteIdentity = tmpBytes
	}
	if rhs := m.InviteIdentitySignature; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.InviteIdentitySignature = tmpBytes
	}
...
func (m *AclAccountRequestJoin) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountRequestAccept) CloneVT() *AclAccountRequestAccept {
	if m == nil {
		return (*AclAccountRequestAccept)(nil)
	}
	r := new(AclAccountRequestAccept)
	r.RequestRecordId = m.RequestRecordId
...
func (m *AclAccountRequestAccept) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountRequestDecline) CloneVT() *AclAccountRequestDecline {
	if m == nil {
		return (*AclAccountRequestDecline)(nil)
	}
	r := new(AclAccountRequestDecline)
	r.RequestRecordId = m.RequestRecordId
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *AclAccountRequestDecline) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountInviteRevoke) CloneVT() *AclAccountInviteRevoke {
	if m == nil {
		return (*AclAccountInviteRevoke)(nil)
	}
	r := new(AclAccountInviteRevoke)
	r.InviteRecordId = m.InviteRecordId
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *AclAccountInviteRevoke) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclEncryptedReadKey) CloneVT() *AclEncryptedReadKey {
	if m == nil {
		return (*AclEncryptedReadKey)(nil)
	}
	r := new(AclEncryptedReadKey)
	if rhs := m.Identity; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.Identity = tmpBytes
...
func (m *AclEncryptedReadKey) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountPermissionChanges) CloneVT() *AclAccountPermissionChanges {
	if m == nil {
		return (*AclAccountPermissionChanges)(nil)
	}
	r := new(AclAccountPermissionChanges)
	if rhs := m.Changes; rhs != nil {
		tmpContainer := make([]*AclAccountPermissionChange, len(rhs))
		for k, v := range rhs {
...
func (m *AclAccountPermissionChanges) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountsAdd) CloneVT() *AclAccountsAdd {
	if m == nil {
		return (*AclAccountsAdd)(nil)
	}
	r := new(AclAccountsAdd)
	if rhs := m.Additions; rhs != nil {
		tmpContainer := make([]*AclAccountAdd, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.Additions = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *AclAccountsAdd) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountAdd) CloneVT() *AclAccountAdd {
	if m == nil {
		return (*AclAccountAdd)(nil)
	}
	r := new(AclAccountAdd)
	r.Permissions = m.Permissions
	if rhs := m.Identity; rhs != nil {
...
func (m *AclAccountAdd) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountRequestCancel) CloneVT() *AclAccountRequestCancel {
	if m == nil {
		return (*AclAccountRequestCancel)(nil)
	}
	r := new(AclAccountRequestCancel)
...
func (m *AclAccountRequestCancel) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountPermissionChange) CloneVT() *AclAccountPermissionChange {
	if m == nil {
		return (*AclAccountPermissionChange)(nil)
	}
	r := new(AclAccountPermissionChange)
	r.Permissions = m.Permissions
	if rhs := m.Identity; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
...
func (m *AclAccountPermissionChange) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclReadKeyChange) CloneVT() *AclReadKeyChange {
	if m == nil {
		return (*AclReadKeyChange)(nil)
	}
	r := new(AclReadKeyChange)
	if rhs := m.AccountKeys; rhs != nil {
		tmpContainer := make([]*AclEncryptedReadKey, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
	...
	if rhs := m.EncryptedOldReadKey; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.EncryptedOldReadKey = tmpBytes
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *AclReadKeyChange) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountRemove) CloneVT() *AclAccountRemove {
	if m == nil {
		return (*AclAccountRemove)(nil)
	}
	r := new(AclAccountRemove)
	r.ReadKeyChange = m.ReadKeyChange.CloneVT()
...
func (m *AclAccountRemove) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclAccountRequestRemove) CloneVT() *AclAccountRequestRemove {
	if m == nil {
		return (*AclAccountRequestRemove)(nil)
	}
	r := new(AclAccountRequestRemove)
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *AclAccountRequestRemove) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclContentValue) CloneVT() *AclContentValue {
	if m == nil {
		return (*AclContentValue)(nil)
	}
	r := new(AclContentValue)
	if m.Value != nil {
		r.Value = m.Value.(interface {
			CloneVT() isAclContentValue_Value
		}).CloneVT()
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *AclContentValue) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *AclContentValue_Invite) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_Invite)(nil)
	}
	r := new(AclContentValue_Invite)
	r.Invite = m.Invite.CloneVT()
	return r
}

func (m *AclContentValue_InviteRevoke) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_InviteRevoke)(nil)
	}
	r := new(AclContentValue_InviteRevoke)
	r.InviteRevoke = m.InviteRevoke.CloneVT()
	return r
}

func (m *AclContentValue_RequestJoin) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_RequestJoin)(nil)
	}
	r := new(AclContentValue_RequestJoin)
	r.RequestJoin = m.RequestJoin.CloneVT()
	return r
}

func (m *AclContentValue_RequestAccept) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_RequestAccept)(nil)
	}
	r := new(AclContentValue_RequestAccept)
	r.RequestAccept = m.RequestAccept.CloneVT()
	return r
}

func (m *AclContentValue_PermissionChange) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_PermissionChange)(nil)
	}
	r := new(AclContentValue_PermissionChange)
	r.PermissionChange = m.PermissionChange.CloneVT()
	return r
}

func (m *AclContentValue_AccountRemove) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_AccountRemove)(nil)
	}
	r := new(AclContentValue_AccountRemove)
	r.AccountRemove = m.AccountRemove.CloneVT()
	return r
}

func (m *AclContentValue_ReadKeyChange) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_ReadKeyChange)(nil)
	}
	r := new(AclContentValue_ReadKeyChange)
	r.ReadKeyChange = m.ReadKeyChange.CloneVT()
	return r
}

func (m *AclContentValue_RequestDecline) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_RequestDecline)(nil)
	}
	r := new(AclContentValue_RequestDecline)
	r.RequestDecline = m.RequestDecline.CloneVT()
	return r
}

func (m *AclContentValue_AccountRequestRemove) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_AccountRequestRemove)(nil)
	}
	r := new(AclContentValue_AccountRequestRemove)
	r.AccountRequestRemove = m.AccountRequestRemove.CloneVT()
	return r
}

func (m *AclContentValue_PermissionChanges) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_PermissionChanges)(nil)
	}
	r := new(AclContentValue_PermissionChanges)
	r.PermissionChanges = m.PermissionChanges.CloneVT()
	return r
}

func (m *AclContentValue_AccountsAdd) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_AccountsAdd)(nil)
	}
	r := new(AclContentValue_AccountsAdd)
	r.AccountsAdd = m.AccountsAdd.CloneVT()
	return r
}

func (m *AclContentValue_RequestCancel) CloneVT() isAclContentValue_Value {
	if m == nil {
		return (*AclContentValue_RequestCancel)(nil)
	}
	r := new(AclContentValue_RequestCancel)
	r.RequestCancel = m.RequestCancel.CloneVT()
	return r
}

func (m *AclData) CloneVT() *AclData {
	if m == nil {
		return (*AclData)(nil)
	}
	r := new(AclData)
	if rhs := m.AclContent; rhs != nil {
		tmpContainer := make([]*AclContentValue, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.AclContent = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *AclData) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
