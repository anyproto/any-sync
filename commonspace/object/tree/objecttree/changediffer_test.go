...
func TestChangeDiffer_Add(t *testing.T) {
	...
	t.Run("known from tree", func(t *testing.T) {
		differ, _ := NewChangeDiffer(nil)
		// simulate IDs that were known from the tree
		differ.known["3"] = struct{}{}
		differ.known["4"] = struct{}{}
		differ.known["5"] = struct{}{}
