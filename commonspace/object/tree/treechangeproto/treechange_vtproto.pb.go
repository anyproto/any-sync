...
func (m *RootChange) CloneVT() *RootChange {
	if m == nil {
		return (*RootChange)(nil)
	}
	r := new(RootChange)
	r.AclHeadId = m.AclHeadId
	r.SpaceId = m.SpaceId
	...
	if rhs := m.ChangePayload; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.ChangePayload = tmpBytes
	}
...
func (m *RootChange) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TreeChange) CloneVT() *TreeChange {
	if m == nil {
		return (*TreeChange)(nil)
	}
	r := new(TreeChange)
	r.AclHeadId = m.AclHeadId
	r.SnapshotBaseId = m.SnapshotBaseId
	r.ReadKeyId = m.ReadKeyId
	r.Timestamp = m.Timestamp
	r.IsSnapshot = m.IsSnapshot
	r.DataType = m.DataType
	if rhs := m.TreeHeadIds; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.TreeHeadIds = tmpContainer
	}
	if rhs := m.ChangesData; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.ChangesData = tmpBytes
	}
	if rhs := m.Identity; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
...
func (m *TreeChange) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *NoDataTreeChange) CloneVT() *NoDataTreeChange {
	if m == nil {
		return (*NoDataTreeChange)(nil)
	}
	r := new(NoDataTreeChange)
	r.AclHeadId = m.AclHeadId
	r.SnapshotBaseId = m.SnapshotBaseId
	r.ReadKeyId = m.ReadKeyId
	r.Timestamp = m.Timestamp
...
func (m *NoDataTreeChange) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *ReducedTreeChange) CloneVT() *ReducedTreeChange {
	if m == nil {
		return (*ReducedTreeChange)(nil)
	}
	r := new(ReducedTreeChange)
	if rhs := m.TreeHeadIds; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.TreeHeadIds = tmpContainer
...
func (m *ReducedTreeChange) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *RawTreeChange) CloneVT() *RawTreeChange {
	if m == nil {
		return (*RawTreeChange)(nil)
	}
	r := new(RawTreeChange)
...
func (m *RawTreeChange) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *RawTreeChangeWithId) CloneVT() *RawTreeChangeWithId {
	if m == nil {
		return (*RawTreeChangeWithId)(nil)
	}
	r := new(RawTreeChangeWithId)
	r.Id = m.Id
	if rhs := m.RawChange; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
		r.RawChange = tmpBytes
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *RawTreeChangeWithId) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TreeSyncMessage) CloneVT() *TreeSyncMessage {
	if m == nil {
		return (*TreeSyncMessage)(nil)
	}
	r := new(TreeSyncMessage)
	r.Content = m.Content.CloneVT()
	r.RootChange = m.RootChange.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *TreeSyncMessage) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TreeSyncContentValue) CloneVT() *TreeSyncContentValue {
	if m == nil {
		return (*TreeSyncContentValue)(nil)
	}
	r := new(TreeSyncContentValue)
	if m.Value != nil {
		r.Value = m.Value.(interface {
			CloneVT() isTreeSyncContentValue_Value
		}).CloneVT()
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *TreeSyncContentValue) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TreeSyncContentValue_HeadUpdate) CloneVT() isTreeSyncContentValue_Value {
	if m == nil {
		return (*TreeSyncContentValue_HeadUpdate)(nil)
	}
	r := new(TreeSyncContentValue_HeadUpdate)
	r.HeadUpdate = m.HeadUpdate.CloneVT()
	return r
}

func (m *TreeSyncContentValue_FullSyncRequest) CloneVT() isTreeSyncContentValue_Value {
	if m == nil {
		return (*TreeSyncContentValue_FullSyncRequest)(nil)
	}
	r := new(TreeSyncContentValue_FullSyncRequest)
	r.FullSyncRequest = m.FullSyncRequest.CloneVT()
	return r
}

func (m *TreeSyncContentValue_FullSyncResponse) CloneVT() isTreeSyncContentValue_Value {
	if m == nil {
		return (*TreeSyncContentValue_FullSyncResponse)(nil)
	}
	r := new(TreeSyncContentValue_FullSyncResponse)
	r.FullSyncResponse = m.FullSyncResponse.CloneVT()
	return r
}

func (m *TreeSyncContentValue_ErrorResponse) CloneVT() isTreeSyncContentValue_Value {
	if m == nil {
		return (*TreeSyncContentValue_ErrorResponse)(nil)
	}
	r := new(TreeSyncContentValue_ErrorResponse)
	r.ErrorResponse = m.ErrorResponse.CloneVT()
	return r
}

func (m *TreeHeadUpdate) CloneVT() *TreeHeadUpdate {
	if m == nil {
		return (*TreeHeadUpdate)(nil)
	}
	r := new(TreeHeadUpdate)
	if rhs := m.Heads; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.Heads = tmpContainer
	}
	if rhs := m.Changes; rhs != nil {
		tmpContainer := make([]*RawTreeChangeWithId, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.Changes = tmpContainer
	}
	if rhs := m.SnapshotPath; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.SnapshotPath = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *TreeHeadUpdate) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TreeFullSyncRequest) CloneVT() *TreeFullSyncRequest {
	if m == nil {
		return (*TreeFullSyncRequest)(nil)
	}
	r := new(TreeFullSyncRequest)
	if rhs := m.Heads; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.Heads = tmpContainer
...
func (m *TreeFullSyncRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TreeFullSyncResponse) CloneVT() *TreeFullSyncResponse {
	if m == nil {
		return (*TreeFullSyncResponse)(nil)
	}
	r := new(TreeFullSyncResponse)
	if rhs := m.Heads; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
		r.Heads = tmpContainer
...
func (m *TreeFullSyncResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TreeErrorResponse) CloneVT() *TreeErrorResponse {
	if m == nil {
		return (*TreeErrorResponse)(nil)
	}
	r := new(TreeErrorResponse)
	r.Error = m.Error
	r.ErrCode = m.ErrCode
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *TreeErrorResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *TreeChangeInfo) CloneVT() *TreeChangeInfo {
	if m == nil {
		return (*TreeChangeInfo)(nil)
	}
	r := new(TreeChangeInfo)
	r.ChangeType = m.ChangeType
	if rhs := m.ChangePayload; rhs != nil {
		tmpBytes := make([]byte, len(rhs))
		copy(tmpBytes, rhs)
...
func (m *TreeChangeInfo) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
