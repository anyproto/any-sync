...
func (m *SpacePullResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.AclRecords) > 0 {
		for iNdEx := len(m.AclRecords) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.AclRecords[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StoreKeyValue) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.PeerSignature) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.PeerSignature)))
		i--
		dAtA[i] = 0x22
	}
	...
	if len(m.KeyPeerId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.KeyPeerId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *StoreKeyInner) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TimestampMicro != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.TimestampMicro))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Value) > 0 {
...
func (m *StoreDeletePrefix) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *StoreDeletePrefix) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *StoreDeletePrefix) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *StoreKeyInner) SizeVT() (n int) {
	...
	if m.TimestampMicro != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.TimestampMicro))
	}
	l = len(m.AclHeadId)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
...
func (m *StoreDeletePrefix) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SpacePullResponse) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.AclRecords[len(m.AclRecords)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StoreKeyInner) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.Delete == nil {
				m.Delete = &StoreDeletePrefix{}
			}
			if err := m.Delete.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StoreDeletePrefix) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StoreDeletePrefix: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StoreDeletePrefix: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
