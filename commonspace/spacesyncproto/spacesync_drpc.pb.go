...
func (x *drpcSpaceSync_HeadSyncStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_StoreDiffStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_StoreElementsStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_SpacePushStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_SpacePullStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_ObjectSyncStreamStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_ObjectSyncStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_ObjectSyncRequestStreamStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_AclAddRecordStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcSpaceSync_AclGetRecordsStream) GetStream() drpc.Stream {
	return x.Stream
}
