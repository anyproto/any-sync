...
type DRPCCoordinatorClient interface {
	...
	EventLog(ctx context.Context, in *EventLogRequest) (*EventLogResponse, error)
}
...
func (c *drpcCoordinatorClient) EventLog(ctx context.Context, in *EventLogRequest) (*EventLogResponse, error) {
	out := new(EventLogResponse)
	err := c.cc.Invoke(ctx, "/coordinator.Coordinator/EventLog", drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCCoordinatorServer interface {
	...
	EventLog(context.Context, *EventLogRequest) (*EventLogResponse, error)
}
...
func (s *DRPCCoordinatorUnimplementedServer) EventLog(context.Context, *EventLogRequest) (*EventLogResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCCoordinatorDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 14:
		return "/coordinator.Coordinator/EventLog", drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCCoordinatorServer).
					EventLog(
						ctx,
			...
			}, DRPCCoordinatorServer.EventLog, true
	default:
...
type DRPCCoordinator_EventLogStream interface {
	drpc.Stream
	SendAndClose(*EventLogResponse) error
}

type drpcCoordinator_EventLogStream struct {
	drpc.Stream
}

func (x *drpcCoordinator_EventLogStream) SendAndClose(m *EventLogResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
