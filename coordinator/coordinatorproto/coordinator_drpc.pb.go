...
type DRPCCoordinatorClient interface {
	...
	AclDeleteInvite(ctx context.Context, in *AclDeleteInviteRequest) (*AclDeleteInviteResponse, error)
...
func (c *drpcCoordinatorClient) AclDeleteInvite(ctx context.Context, in *AclDeleteInviteRequest) (*AclDeleteInviteResponse, error) {
	out := new(AclDeleteInviteResponse)
	err := c.cc.Invoke(ctx, "/coordinator.Coordinator/AclDeleteInvite", drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCCoordinatorServer interface {
	...
	AclDeleteInvite(context.Context, *AclDeleteInviteRequest) (*AclDeleteInviteResponse, error)
...
func (s *DRPCCoordinatorUnimplementedServer) AclDeleteInvite(context.Context, *AclDeleteInviteRequest) (*AclDeleteInviteResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCCoordinatorDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 19:
		return "/coordinator.Coordinator/AclDeleteInvite", drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCCoordinatorServer).
					AclDeleteInvite(
						ctx,
						in1.(*AclDeleteInviteRequest),
					)
			}, DRPCCoordinatorServer.AclDeleteInvite, true
	case 20:
...
type DRPCCoordinator_AclDeleteInviteStream interface {
	drpc.Stream
	SendAndClose(*AclDeleteInviteResponse) error
}

type drpcCoordinator_AclDeleteInviteStream struct {
	drpc.Stream
}

func (x *drpcCoordinator_AclDeleteInviteStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcCoordinator_AclDeleteInviteStream) SendAndClose(m *AclDeleteInviteResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
