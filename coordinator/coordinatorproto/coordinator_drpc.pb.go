...
type DRPCCoordinatorClient interface {
	...
	ExternalCompartments(ctx context.Context, in *ExternalCompartmentsRequest) (*ExternalCompartmentsResponse, error)
...
func (c *drpcCoordinatorClient) ExternalCompartments(ctx context.Context, in *ExternalCompartmentsRequest) (*ExternalCompartmentsResponse, error) {
	out := new(ExternalCompartmentsResponse)
	err := c.cc.Invoke(ctx, "/coordinator.Coordinator/ExternalCompartments", drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcCoordinatorClient) InboxAddMessage(ctx context.Context, in *InboxAddMessageRequest) (*InboxAddMessageResponse, error) {
	out := new(InboxAddMessageResponse)
	err := c.cc.Invoke(ctx, "/coordinator.Coordinator/InboxAddMessage", drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCCoordinatorServer interface {
	...
	ExternalCompartments(context.Context, *ExternalCompartmentsRequest) (*ExternalCompartmentsResponse, error)
...
func (s *DRPCCoordinatorUnimplementedServer) ExternalCompartments(context.Context, *ExternalCompartmentsRequest) (*ExternalCompartmentsResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (s *DRPCCoordinatorUnimplementedServer) InboxAddMessage(context.Context, *InboxAddMessageRequest) (*InboxAddMessageResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCCoordinatorDescription) NumMethods() int { return 22 }
...
func (DRPCCoordinatorDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 14:
		return "/coordinator.Coordinator/ExternalCompartments", drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCCoordinatorServer).
					ExternalCompartments(
						ctx,
						in1.(*ExternalCompartmentsRequest),
					)
			}, DRPCCoordinatorServer.ExternalCompartments, true
	case 15:
	...
	case 17:
		return "/coordinator.Coordinator/InboxAddMessage", drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCCoordinatorServer).
					InboxAddMessage(
						ctx,
						in1.(*InboxAddMessageRequest),
					)
...
func (x *drpcCoordinator_SpaceSignStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_SpaceStatusCheckStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_SpaceStatusCheckManyStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_SpaceStatusChangeStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_SpaceMakeShareableStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_SpaceMakeUnshareableStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_NetworkConfigurationStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_DeletionLogStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_SpaceDeleteStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_AccountDeleteStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_AccountRevertDeletionStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_AclAddRecordStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_AclGetRecordsStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_AccountLimitsSetStream) GetStream() drpc.Stream {
	return x.Stream
}
...
type DRPCCoordinator_ExternalCompartmentsStream interface {
	drpc.Stream
	SendAndClose(*ExternalCompartmentsResponse) error
}

type drpcCoordinator_ExternalCompartmentsStream struct {
	drpc.Stream
}

func (x *drpcCoordinator_ExternalCompartmentsStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcCoordinator_ExternalCompartmentsStream) SendAndClose(m *ExternalCompartmentsResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
func (x *drpcCoordinator_AclEventLogStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_InboxFetchStream) GetStream() drpc.Stream {
	return x.Stream
}
...
type DRPCCoordinator_InboxAddMessageStream interface {
	drpc.Stream
	SendAndClose(*InboxAddMessageResponse) error
}

type drpcCoordinator_InboxAddMessageStream struct {
	drpc.Stream
}

func (x *drpcCoordinator_InboxAddMessageStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcCoordinator_InboxAddMessageStream) SendAndClose(m *InboxAddMessageResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_coordinator_coordinatorproto_protos_coordinator_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
func (x *drpcCoordinator_NotifySubscribeStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_AclUploadInviteStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_FileLimitsGetStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcCoordinator_FileUsageReportStream) GetStream() drpc.Stream {
	return x.Stream
}
