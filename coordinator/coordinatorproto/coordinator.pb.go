...
type NetworkConfigurationResponse struct {
	...
	FileNetworkId string `protobuf:"bytes,6,opt,name=fileNetworkId,proto3" json:"fileNetworkId,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_coordinator_coordinatorproto_protos_coordinator_proto_rawDesc = "" +
	...
	"\x0fAclDeleteInvite\x12#.coordinator.AclDeleteInviteRequest\x1a$.coordinator.AclDeleteInviteResponse\x12V\n" +
...
var file_coordinator_coordinatorproto_protos_coordinator_proto_depIdxs = []int32{
	...
	63, // 44: coordinator.Coordinator.AclDeleteInvite:input_type -> coordinator.AclDeleteInviteRequest
	...
	50, // 61: coordinator.Coordinator.AclEventLog:output_type -> coordinator.AclEventLogResponse
	56, // 62: coordinator.Coordinator.InboxFetch:output_type -> coordinator.InboxFetchResponse
	58, // 63: coordinator.Coordinator.InboxAddMessage:output_type -> coordinator.InboxAddMessageResponse
	60, // 64: coordinator.Coordinator.NotifySubscribe:output_type -> coordinator.NotifySubscribeEvent
	62, // 65: coordinator.Coordinator.AclUploadInvite:output_type -> coordinator.AclUploadInviteResponse
	64, // 66: coordinator.Coordinator.AclDeleteInvite:output_type -> coordinator.AclDeleteInviteResponse
