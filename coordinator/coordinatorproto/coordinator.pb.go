...
const (
	...
	ErrorCodes_InviteStillActive              ErrorCodes = 13
...
type AclUploadInviteRequest struct {
	...
	// spaceId and invitePubKey bind the uploaded file to its invite, so that AclDeleteInvite
	// can later remove it.
	SpaceId string `protobuf:"bytes,3,opt,name=spaceId,proto3" json:"spaceId,omitempty"`
	// invitePubKey is the PUBLIC part of the invite key. For a guest invite it is the public
	// part of the guest key.
	InvitePubKey  []byte `protobuf:"bytes,4,opt,name=invitePubKey,proto3" json:"invitePubKey,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AclUploadInviteRequest) GetSpaceId() string {
	if x != nil {
		return x.SpaceId
	}
	return ""
...
func (x *AclUploadInviteRequest) GetInvitePubKey() []byte {
	if x != nil {
		return x.InvitePubKey
	}
	return nil
}
...
// AclDeleteInviteRequest asks the coordinator to remove a revoked invite's file from the
// filenodes. The coordinator resolves the cid to its invite through the binding made by
// AclUploadInvite and refuses to remove one that still grants access.
type AclDeleteInviteRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SpaceId       string                 `protobuf:"bytes,1,opt,name=spaceId,proto3" json:"spaceId,omitempty"`
	InviteCid     []byte                 `protobuf:"bytes,2,opt,name=inviteCid,proto3" json:"inviteCid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AclDeleteInviteRequest) Reset() {
	*x = AclDeleteInviteRequest{}
	mi := &file_coordinator_coordinatorproto_protos_coordinator_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AclDeleteInviteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AclDeleteInviteRequest) ProtoMessage() {}

func (x *AclDeleteInviteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_coordinator_coordinatorproto_protos_coordinator_proto_msgTypes[52]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AclDeleteInviteRequest.ProtoReflect.Descriptor instead.
func (*AclDeleteInviteRequest) Descriptor() ([]byte, []int) {
	return file_coordinator_coordinatorproto_protos_coordinator_proto_rawDescGZIP(), []int{52}
}

func (x *AclDeleteInviteRequest) GetSpaceId() string {
	if x != nil {
		return x.SpaceId
	}
	return ""
...
func (x *AclDeleteInviteRequest) GetInviteCid() []byte {
	if x != nil {
		return x.InviteCid
	}
	return nil
...
type AclDeleteInviteResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AclDeleteInviteResponse) Reset() {
	*x = AclDeleteInviteResponse{}
	mi := &file_coordinator_coordinatorproto_protos_coordinator_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AclDeleteInviteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AclDeleteInviteResponse) ProtoMessage() {}

func (x *AclDeleteInviteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_coordinator_coordinatorproto_protos_coordinator_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AclDeleteInviteResponse.ProtoReflect.Descriptor instead.
func (*AclDeleteInviteResponse) Descriptor() ([]byte, []int) {
...
const file_coordinator_coordinatorproto_protos_coordinator_proto_rawDesc = "" +
	...
	"\finvitePubKey\x18\x04 \x01(\fR\finvitePubKey\"\x19\n" +
	"\x17AclUploadInviteResponse\"P\n" +
	"\x16AclDeleteInviteRequest\x12\x18\n" +
	...
	"\x1eSubscribePeerAlreadySubscribed\x10\f\x12\x15\n" +
	"\x11InviteStillActive\x10\r\x12\x10\n" +
	...
	"\x0fAclDeleteInvite\x12#.coordinator.AclDeleteInviteRequest\x1a$.coordinator.AclDeleteInviteResponseB\x1eZ\x1ccoordinator/coordinatorprotob\x06proto3"
...
var file_coordinator_coordinatorproto_protos_coordinator_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_coordinator_coordinatorproto_protos_coordinator_proto_goTypes = []any{
	...
	(*AclDeleteInviteRequest)(nil),              // 63: coordinator.AclDeleteInviteRequest
	(*AclDeleteInviteResponse)(nil),             // 64: coordinator.AclDeleteInviteResponse
}
var file_coordinator_coordinatorproto_protos_coordinator_proto_depIdxs = []int32{
	...
	63, // 43: coordinator.Coordinator.AclDeleteInvite:input_type -> coordinator.AclDeleteInviteRequest
	14, // 44: coordinator.Coordinator.SpaceSign:output_type -> coordinator.SpaceSignResponse
	18, // 45: coordinator.Coordinator.SpaceStatusCheck:output_type -> coordinator.SpaceStatusCheckResponse
	20, // 46: coordinator.Coordinator.SpaceStatusCheckMany:output_type -> coordinator.SpaceStatusCheckManyResponse
	23, // 47: coordinator.Coordinator.SpaceStatusChange:output_type -> coordinator.SpaceStatusChangeResponse
	25, // 48: coordinator.Coordinator.SpaceMakeShareable:output_type -> coordinator.SpaceMakeShareableResponse
	27, // 49: coordinator.Coordinator.SpaceMakeUnshareable:output_type -> coordinator.SpaceMakeUnshareableResponse
	29, // 50: coordinator.Coordinator.NetworkConfiguration:output_type -> coordinator.NetworkConfigurationResponse
	34, // 51: coordinator.Coordinator.DeletionLog:output_type -> coordinator.DeletionLogResponse
	37, // 52: coordinator.Coordinator.SpaceDelete:output_type -> coordinator.SpaceDeleteResponse
	40, // 53: coordinator.Coordinator.AccountDelete:output_type -> coordinator.AccountDeleteResponse
	42, // 54: coordinator.Coordinator.AccountRevertDeletion:output_type -> coordinator.AccountRevertDeletionResponse
	44, // 55: coordinator.Coordinator.AclAddRecord:output_type -> coordinator.AclAddRecordResponse
	46, // 56: coordinator.Coordinator.AclGetRecords:output_type -> coordinator.AclGetRecordsResponse
	48, // 57: coordinator.Coordinator.AccountLimitsSet:output_type -> coordinator.AccountLimitsSetResponse
	50, // 58: coordinator.Coordinator.AclEventLog:output_type -> coordinator.AclEventLogResponse
	56, // 59: coordinator.Coordinator.InboxFetch:output_type -> coordinator.InboxFetchResponse
	58, // 60: coordinator.Coordinator.InboxAddMessage:output_type -> coordinator.InboxAddMessageResponse
	60, // 61: coordinator.Coordinator.NotifySubscribe:output_type -> coordinator.NotifySubscribeEvent
	62, // 62: coordinator.Coordinator.AclUploadInvite:output_type -> coordinator.AclUploadInviteResponse
	64, // 63: coordinator.Coordinator.AclDeleteInvite:output_type -> coordinator.AclDeleteInviteResponse
