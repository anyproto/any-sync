...
var NotifyEventType_name = map[int32]string{
	0: "UnspecifiedEvent",
	1: "InboxNewMessageEvent",
	2: "NetworkConfigChangedEvent",
}

var NotifyEventType_value = map[string]int32{
	"UnspecifiedEvent":          0,
...
func (x NotifyEventType) String() string {
	return proto.EnumName(NotifyEventType_name, int32(x))
}
...
func (m *InboxPacket) GetSenderIdentity() string {
	if m != nil {
...
func (m *InboxPacket) GetReceiverIdentity() string {
	if m != nil {
		return m.ReceiverIdentity
	}
	return ""
}
...
func (m *InboxFetchResponse) GetHasMore() bool {
	if m != nil {
		return m.HasMore
	}
	return false
...
func (m *NotifySubscribeRequest) Reset()         { *m = NotifySubscribeRequest{} }
func (m *NotifySubscribeRequest) String() string { return proto.CompactTextString(m) }
func (*NotifySubscribeRequest) ProtoMessage()    {}
func (*NotifySubscribeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d94f6f99586adae2, []int{50}
}
func (m *NotifySubscribeRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NotifySubscribeRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NotifySubscribeRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NotifySubscribeRequest) XXX_MarshalAppend(b []byte, newLen int) ([]byte, error) {
	b = b[:newLen]
	_, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *NotifySubscribeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NotifySubscribeRequest.Merge(m, src)
}
func (m *NotifySubscribeRequest) XXX_Size() int {
	return m.Size()
}
func (m *NotifySubscribeRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_NotifySubscribeRequest.DiscardUnknown(m)
}

var xxx_messageInfo_NotifySubscribeRequest proto.InternalMessageInfo

func (m *NotifySubscribeRequest) GetEventType() NotifyEventType {
	if m != nil {
		return m.EventType
	}
...
type NotifySubscribeEvent struct {
	...
	//
	//	*NotifySubscribeEvent_InboxEvent
	Event isNotifySubscribeEventEvent `protobuf_oneof:"event"`
}

func (m *NotifySubscribeEvent) Reset()         { *m = NotifySubscribeEvent{} }
func (m *NotifySubscribeEvent) String() string { return proto.CompactTextString(m) }
func (*NotifySubscribeEvent) ProtoMessage()    {}
func (*NotifySubscribeEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_d94f6f99586adae2, []int{51}
}
func (m *NotifySubscribeEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NotifySubscribeEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NotifySubscribeEvent.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *NotifySubscribeEvent) XXX_MarshalAppend(b []byte, newLen int) ([]byte, error) {
	b = b[:newLen]
	_, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *NotifySubscribeEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NotifySubscribeEvent.Merge(m, src)
}
func (m *NotifySubscribeEvent) XXX_Size() int {
	return m.Size()
}
func (m *NotifySubscribeEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_NotifySubscribeEvent.DiscardUnknown(m)
}

var xxx_messageInfo_NotifySubscribeEvent proto.InternalMessageInfo

type isNotifySubscribeEventEvent interface {
	isNotifySubscribeEventEvent()
	MarshalTo([]byte) (int, error)
	Size() int
}

type NotifySubscribeEvent_InboxEvent struct {
	InboxEvent *InboxNotifySubscribeEvent `protobuf:"bytes,1,opt,name=inboxEvent,proto3,oneof" json:"inboxEvent,omitempty"`
}

func (*NotifySubscribeEvent_InboxEvent) isNotifySubscribeEventEvent() {}

func (m *NotifySubscribeEvent) GetEvent() isNotifySubscribeEventEvent {
	if m != nil {
		return m.Event
	}
	return nil
...
func (m *NotifySubscribeEvent) GetInboxEvent() *InboxNotifySubscribeEvent {
	if x, ok := m.GetEvent().(*NotifySubscribeEvent_InboxEvent); ok {
		return x.InboxEvent
	}
	return nil
}
...
func (*NotifySubscribeEvent) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*NotifySubscribeEvent_InboxEvent)(nil),
	}
}
...
func init() {
	...
	proto.RegisterEnum("coordinator.NotifyEventType", NotifyEventType_name, NotifyEventType_value)
	...
	proto.RegisterType((*NotifySubscribeRequest)(nil), "coordinator.NotifySubscribeRequest")
	proto.RegisterType((*NotifySubscribeEvent)(nil), "coordinator.NotifySubscribeEvent")
}
...
var fileDescriptor_d94f6f99586adae2 = []byte{
	...
	,
}
...
func (m *InboxPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReceiverIdentity) > 0 {
		i -= len(m.ReceiverIdentity)
		copy(dAtA[i:], m.ReceiverIdentity)
		i = encodeVarintCoordinator(dAtA, i, uint64(len(m.ReceiverIdentity)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *NotifySubscribeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NotifySubscribeRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NotifySubscribeRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.EventType != 0 {
		i = encodeVarintCoordinator(dAtA, i, uint64(m.EventType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *NotifySubscribeEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *NotifySubscribeEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NotifySubscribeEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *NotifySubscribeEvent_InboxEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *NotifySubscribeEvent_InboxEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.InboxEvent != nil {
		{
			size, err := m.InboxEvent.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *NotifySubscribeRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.EventType != 0 {
		n += 1 + sovCoordinator(uint64(m.EventType))
	}
	return n
}

func (m *NotifySubscribeEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *NotifySubscribeEvent_InboxEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InboxPacket) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.SenderIdentity = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReceiverIdentity", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ReceiverIdentity = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
...
func (m *NotifySubscribeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NotifySubscribeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NotifySubscribeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EventType |= NotifyEventType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *NotifySubscribeEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NotifySubscribeEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NotifySubscribeEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InboxEvent", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &InboxNotifySubscribeEvent{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Event = &NotifySubscribeEvent_InboxEvent{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCoordinator(dAtA[iNdEx:])
