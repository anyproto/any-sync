...
type EventLogRecordType int32

const (
	EventLogRecordType_RecordTypeSpaceReceipt          EventLogRecordType = 0
	EventLogRecordType_RecordTypeSpaceSharedOrUnshared EventLogRecordType = 1
	EventLogRecordType_RecordTypeSpaceAclAddRecord     EventLogRecordType = 2
)

var EventLogRecordType_name = map[int32]string{
	0: "RecordTypeSpaceReceipt",
	1: "RecordTypeSpaceSharedOrUnshared",
	2: "RecordTypeSpaceAclAddRecord",
}

var EventLogRecordType_value = map[string]int32{
	"RecordTypeSpaceReceipt":          0,
	"RecordTypeSpaceSharedOrUnshared": 1,
	"RecordTypeSpaceAclAddRecord":     2,
}

func (x EventLogRecordType) String() string {
	return proto.EnumName(EventLogRecordType_name, int32(x))
}

func (EventLogRecordType) EnumDescriptor() ([]byte, []int) {
...
type EventLogRequest struct {
	...
	// TODO: ? NetworkId is the id of a network where event log is requested
	// string networkId = 2;
	// AfterId is the last known logId to request records after this id. If it is empty will be returned a list from the beginning.
...
func (m *EventLogRequest) Reset()         { *m = EventLogRequest{} }
func (m *EventLogRequest) String() string { return proto.CompactTextString(m) }
func (*EventLogRequest) ProtoMessage()    {}
func (*EventLogRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d94f6f99586adae2, []int{38}
}
func (m *EventLogRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventLogRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventLogRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventLogRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventLogRequest.Merge(m, src)
}
func (m *EventLogRequest) XXX_Size() int {
	return m.Size()
}
func (m *EventLogRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_EventLogRequest.DiscardUnknown(m)
}

var xxx_messageInfo_EventLogRequest proto.InternalMessageInfo

func (m *EventLogRequest) GetAccountIdentity() string {
	if m != nil {
		return m.AccountIdentity
	}
	return ""
...
func (m *EventLogRequest) GetAfterId() string {
	if m != nil {
		return m.AfterId
	}
	return ""
...
func (m *EventLogRequest) GetLimit() uint32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
type EventLogResponse struct {
	// EventLogRecord list of records, if there are no new records will be empty
	Records []*EventLogRecord `protobuf:"bytes,1,rep,name=records,proto3" json:"records,omitempty"`
	// HasMore indicates if there are records left
	HasMore bool `protobuf:"varint,2,opt,name=hasMore,proto3" json:"hasMore,omitempty"`
}

func (m *EventLogResponse) Reset()         { *m = EventLogResponse{} }
func (m *EventLogResponse) String() string { return proto.CompactTextString(m) }
func (*EventLogResponse) ProtoMessage()    {}
func (*EventLogResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d94f6f99586adae2, []int{39}
}
func (m *EventLogResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventLogResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventLogResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventLogResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventLogResponse.Merge(m, src)
}
func (m *EventLogResponse) XXX_Size() int {
	return m.Size()
}
func (m *EventLogResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_EventLogResponse.DiscardUnknown(m)
}

var xxx_messageInfo_EventLogResponse proto.InternalMessageInfo

func (m *EventLogResponse) GetRecords() []*EventLogRecord {
	if m != nil {
		return m.Records
	}
	return nil
...
func (m *EventLogResponse) GetHasMore() bool {
	if m != nil {
		return m.HasMore
	}
	return false
...
type EventLogRecord struct {
	...
	Type EventLogRecordType `protobuf:"varint,4,opt,name=type,proto3,enum=coordinator.EventLogRecordType" json:"type,omitempty"`
}
...
func (m *EventLogRecord) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventLogRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventLogRecord.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventLogRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventLogRecord.Merge(m, src)
}
func (m *EventLogRecord) XXX_Size() int {
	return m.Size()
}
func (m *EventLogRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_EventLogRecord.DiscardUnknown(m)
}

var xxx_messageInfo_EventLogRecord proto.InternalMessageInfo

func (m *EventLogRecord) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *EventLogRecord) GetSpaceId() string {
	if m != nil {
		return m.SpaceId
	}
	return ""
...
func (m *EventLogRecord) GetType() EventLogRecordType {
	if m != nil {
		return m.Type
	}
	return EventLogRecordType_RecordTypeSpaceReceipt
}
...
func init() {
	...
	proto.RegisterEnum("coordinator.EventLogRecordType", EventLogRecordType_name, EventLogRecordType_value)
	...
	proto.RegisterType((*EventLogRequest)(nil), "coordinator.EventLogRequest")
	proto.RegisterType((*EventLogResponse)(nil), "coordinator.EventLogResponse")
	proto.RegisterType((*EventLogRecord)(nil), "coordinator.EventLogRecord")
}
...
var fileDescriptor_d94f6f99586adae2 = []byte{
	...
	,
}
...
func (m *EventLogRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventLogRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventLogRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventLogResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventLogResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventLogResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventLogRecord) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventLogRecord) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventLogRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventLogRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventLogResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventLogRecord) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventLogRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventLogRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventLogRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *EventLogResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventLogResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventLogResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Records = append(m.Records, &EventLogRecord{})
			if err := m.Records[len(m.Records)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *EventLogRecord) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventLogRecord: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventLogRecord: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= EventLogRecordType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
