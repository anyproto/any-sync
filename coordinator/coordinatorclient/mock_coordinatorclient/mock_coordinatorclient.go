...
func (m *MockCoordinatorClient) AclUploadInvite(arg0 context.Context, arg1 blocks.Block) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AclUploadInvite", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// AclUploadInvite indicates an expected call of AclUploadInvite.
func (mr *MockCoordinatorClientMockRecorder) AclUploadInvite(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AclUploadInvite", reflect.TypeOf((*MockCoordinatorClient)(nil).AclUploadInvite), arg0, arg1)
}
