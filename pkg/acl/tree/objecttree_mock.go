...
func (m *MockObjectTree) AddContent(arg0 context.Context, arg1 SignableChangeContent) (AddResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddContent", arg0, arg1)
	ret0, _ := ret[0].(AddResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockObjectTree) AddRawChanges(arg0 context.Context, arg1 ...*treechangeproto.RawTreeChangeWithId) (AddResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockObjectTree) Iterate(arg0 func([]byte) (interface{}, error), arg1 func(*Change) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockObjectTree) IterateFrom(arg0 string, arg1 func([]byte) (interface{}, error), arg2 func(*Change) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockObjectTree) Root() *Change {
	m.ctrl.T.Helper()
