...
func (m *MockACLList) ACLState() *ACLState {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ACLState")
	ret0, _ := ret[0].(*ACLState)
	return ret0
}
...
func (m *MockACLList) Get(arg0 string) (*ACLRecord, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].(*ACLRecord)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockACLList) Head() *ACLRecord {
	m.ctrl.T.Helper()
...
func (m *MockACLList) Iterate(arg0 func(*ACLRecord) bool) {
	m.ctrl.T.Helper()
...
func (m *MockACLList) IterateFrom(arg0 string, arg1 func(*ACLRecord) bool) {
	m.ctrl.T.Helper()
...
func (m *MockACLList) Records() []*ACLRecord {
	m.ctrl.T.Helper()
