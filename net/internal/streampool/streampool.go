...
func (s *streamPool) Send(ctx context.Context, msg drpc.Message, peerGetter streampool2.PeerGetter) (err error) {
...
func (s *streamPool) SendById(ctx context.Context, msg drpc.Message, peerIds ...string) (err error) {
	...
	if len(streamsByPeer) == 0 {
		return neterr.ErrUnableToConnect
	}
	return
}
