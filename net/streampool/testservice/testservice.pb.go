...
func (m *StreamMessage) GetRepeat() int64 {
	if m != nil {
		return m.Repeat
	}
	return 0
...
var fileDescriptor_1c28d5a3a78be18f = []byte{
	...
	,
}
...
func (m *StreamMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Repeat != 0 {
		i = encodeVarintTestservice(dAtA, i, uint64(m.Repeat))
		i--
		dAtA[i] = 0x10
	}
	if len(m.ReqData) > 0 {
...
func (m *StreamMessage) Size() (n int) {
	...
	if m.Repeat != 0 {
		n += 1 + sovTestservice(uint64(m.Repeat))
	}
	return n
}
