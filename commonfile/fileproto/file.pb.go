...
type BlockDeleteUnboundRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Cid           []byte                 `protobuf:"bytes,1,opt,name=cid,proto3" json:"cid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *BlockDeleteUnboundRequest) Reset() {
	*x = BlockDeleteUnboundRequest{}
	mi := &file_commonfile_fileproto_protos_file_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BlockDeleteUnboundRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlockDeleteUnboundRequest) ProtoMessage() {}

func (x *BlockDeleteUnboundRequest) ProtoReflect() protoreflect.Message {
	mi := &file_commonfile_fileproto_protos_file_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlockDeleteUnboundRequest.ProtoReflect.Descriptor instead.
func (*BlockDeleteUnboundRequest) Descriptor() ([]byte, []int) {
	return file_commonfile_fileproto_protos_file_proto_rawDescGZIP(), []int{26}
}

func (x *BlockDeleteUnboundRequest) GetCid() []byte {
	if x != nil {
		return x.Cid
	}
	return nil
...
const file_commonfile_fileproto_protos_file_proto_rawDesc = "" +
	...
	"\x19BlockDeleteUnboundRequest\x12\x10\n" +
	"\x03cid\x18\x01 \x01(\fR\x03cid*\xce\x01\n" +
	"\bErrCodes\x12\x0e\n" +
	"\n" +
	...
	"\rSpaceLimitSet\x12\x1e.filesync.SpaceLimitSetRequest\x1a\f.filesync.Ok\x12G\n" +
	"\x12BlockDeleteUnbound\x12#.filesync.BlockDeleteUnboundRequest\x1a\f.filesync.OkB\x16Z\x14commonfile/fileprotob\x06proto3"
...
var file_commonfile_fileproto_protos_file_proto_goTypes = []any{
	...
	(*BlockDeleteUnboundRequest)(nil), // 28: filesync.BlockDeleteUnboundRequest
}
var file_commonfile_fileproto_protos_file_proto_depIdxs = []int32{
	...
	28, // 19: filesync.File.BlockDeleteUnbound:input_type -> filesync.BlockDeleteUnboundRequest
	...
	2,  // 33: filesync.File.BlockDeleteUnbound:output_type -> filesync.Ok
