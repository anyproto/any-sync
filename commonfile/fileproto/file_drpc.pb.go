...
type DRPCFileClient interface {
	...
	BlockDeleteUnbound(ctx context.Context, in *BlockDeleteUnboundRequest) (*Ok, error)
}
...
func (c *drpcFileClient) BlockPushMany(ctx context.Context, in *BlockPushManyRequest) (*Ok, error) {
	out := new(Ok)
	err := c.cc.Invoke(ctx, "/filesync.File/BlockPushMany", drpcEncoding_File_commonfile_fileproto_protos_file_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcFileClient) BlockDeleteUnbound(ctx context.Context, in *BlockDeleteUnboundRequest) (*Ok, error) {
	out := new(Ok)
	err := c.cc.Invoke(ctx, "/filesync.File/BlockDeleteUnbound", drpcEncoding_File_commonfile_fileproto_protos_file_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCFileServer interface {
	...
	BlockPushMany(context.Context, *BlockPushManyRequest) (*Ok, error)
	...
	BlockDeleteUnbound(context.Context, *BlockDeleteUnboundRequest) (*Ok, error)
}
...
func (s *DRPCFileUnimplementedServer) BlockPushMany(context.Context, *BlockPushManyRequest) (*Ok, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (s *DRPCFileUnimplementedServer) BlockDeleteUnbound(context.Context, *BlockDeleteUnboundRequest) (*Ok, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}
...
func (DRPCFileDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 2:
		return "/filesync.File/BlockPushMany", drpcEncoding_File_commonfile_fileproto_protos_file_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCFileServer).
					BlockPushMany(
						ctx,
						in1.(*BlockPushManyRequest),
					)
			}, DRPCFileServer.BlockPushMany, true
	case 3:
	...
	case 13:
		return "/filesync.File/BlockDeleteUnbound", drpcEncoding_File_commonfile_fileproto_protos_file_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCFileServer).
					BlockDeleteUnbound(
						ctx,
						in1.(*BlockDeleteUnboundRequest),
					)
			}, DRPCFileServer.BlockDeleteUnbound, true
	default:
...
func (x *drpcFile_BlockGetStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_BlockPushStream) GetStream() drpc.Stream {
	return x.Stream
}
...
type drpcFile_BlockPushManyStream struct {
	drpc.Stream
}

func (x *drpcFile_BlockPushManyStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcFile_BlockPushManyStream) SendAndClose(m *Ok) error {
	if err := x.MsgSend(m, drpcEncoding_File_commonfile_fileproto_protos_file_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
...
func (x *drpcFile_BlocksCheckStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_BlocksBindStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_FilesDeleteStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_FilesInfoStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_FilesGetStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_CheckStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_SpaceInfoStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_AccountInfoStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_AccountLimitSetStream) GetStream() drpc.Stream {
	return x.Stream
}
...
func (x *drpcFile_SpaceLimitSetStream) GetStream() drpc.Stream {
	return x.Stream
}
...
type DRPCFile_BlockDeleteUnboundStream interface {
	drpc.Stream
	SendAndClose(*Ok) error
}

type drpcFile_BlockDeleteUnboundStream struct {
	drpc.Stream
}

func (x *drpcFile_BlockDeleteUnboundStream) GetStream() drpc.Stream {
	return x.Stream
}

func (x *drpcFile_BlockDeleteUnboundStream) SendAndClose(m *Ok) error {
	if err := x.MsgSend(m, drpcEncoding_File_commonfile_fileproto_protos_file_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
