...
func (m *MockSpaceStorageProvider) CreateSpaceStorage(arg0 SpaceStorageCreatePayload) (SpaceStorage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSpaceStorage", arg0)
	ret0, _ := ret[0].(SpaceStorage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSpaceStorageProvider) SpaceStorage(arg0 string) (SpaceStorage, error) {
	m.ctrl.T.Helper()
